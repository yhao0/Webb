...
SELECT * FROM images WHERE section="footer" AND page="FirstPage";
</sql:query>
...
<tr>
 ...
 <div style="width:100%;margin-bottom:80px">
	<a href="UploadImageFooter.jsp" style="text-decoration:none;float:right;border:1px solid black;border-radius:5px;background-color: lightgoldenyellow;">Upload Image</a>
</div>
</body>
</html>